                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <?php
                                             ...
                                             ?>
                                                <a class="dropdown-item" style="cursor: pointer" onclick="delete_model('<?php echo $row['branch_id']; ?>')">Delete</a>
                                             <?php
                                                    }
                                            ?>
                                        </div>
                            ...
                            <form id="branch_form" autocomplete="off">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="Incharge" id="incharge" name="incharge" style="border-color: #181f5a;color: black">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label>Mobile *</label>
                                    ...
                                    <div class="form-group col-md-12">
                                        <label>Address</label>
                                        <textarea class="form-control" placeholder="Address" id="location" name="location" cols="70" rows="4" style="border: 1px solid black;color: black;"></textarea>
