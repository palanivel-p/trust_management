...
<body>
<div id="printPdf" style="border: 4px solid #3c99e6; height:80%; margin-right:8px;">
    <div class="headerPdf flex-container">
        <div class="pdfLogo flex-start" style="margin-left: 10px;margin-top: 10px;">
            <img src="../images/final_logo.png" style="height: 150px;width: 150px;">
        </div>
        <div class="headerCont flex-end" style="margin-left: -50px;margin-top: 45px;font-family: 'Poppins', sans-serif;">
    ...
    <div>
        <div class="mainContent_pdf s row" style="margin-top: 15px;">
            <?php
              if($type == '80G'){
            ?>
                <h2 style="margin-left: 160px; margin-bottom: 10px;"><span style="border-bottom: 1px solid black!important;font-family: 'Poppins', sans-serif;">DONATION 80G RECEIPT</span></h2>
            <?php
              }else {
             ?>
                  <h2 style="margin-left: 160px; margin-bottom: 10px;"><span style="border-bottom: 1px solid black!important;font-family: 'Poppins', sans-serif;">DONATION RECEIPT</span></h2>
             <?php
                }
            ?>
            <!--left side data-->
            ...
            <div class="left column">
                ...
                <div style="margin-top: 9px;margin-left: 25px;">
                    <p style="display: inline-block;font-family: 'Poppins', sans-serif;">Donation Date :</p><span style="border-bottom: 1px dashed black;font-family: 'Poppins', sans-serif;"> <?php echo "----------"?></span>
                </div>
            ...
            <div class="left column">
                <p style="margin-top: -14px!important;color:#3C99E6;font-family: 'Great Vibes', cursive; font-size: 25px;">Thank you for yopur compossionate support and for making a meaningful diffrent in the lines of both the Young and the Old</p>
            </div>

            <!--Right side data-->
            <div class="right column">
                <div style="display: flex;justify-content: end; margin-bottom:-5px;margin-top: 10px; margin-right: -20px; height:100px !important;">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="left-div">
                    ...
                    <p><span style= "color:#3c99e6;" class="material-symbols-outlined">location_on</span>No.63,Bajanai Kovil Street,</p>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mandhanankuppam,Kolathur,</p>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Chennai,Tamilnadu.</p>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pincode-600099</p>
                    <p><span style= "color:#3c99e6;"class="material-symbols-outlined">tty</span>+99-8939885777</p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="right-div">
                    <h4 style="border-bottom: 1px solid black;margin-bottom: 2px;width: 215px;">Annai Teresa Old Age Home</h4>
                    <p><span style= "color:#3c99e6;" class="material-symbols-outlined">location_on</span>No.47,Outer Circular Road,</p>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;kilpauk Garden Colony,kilpauk,</p>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Chennai,Tamilnadu.</p>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pincode-600010</p>
                    <p><span style= "color:#3c99e6;"class="material-symbols-outlined">tty</span>+99-9087822777</p>
                </div>
            </div>
        </div>
    </div>
