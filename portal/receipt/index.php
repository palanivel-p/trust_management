...
if($_COOKIE['role'] == 'Super Admin'){
    ...
    if ($_COOKIE['role'] == 'Admin'){
        ...
        $addedBranchSerach = "AND verify='1' AND added_by='$cookieStaffId' AND branch_name='$cookieBranch_Id'";
...
<!--                                <td>--><?php //echo $batchName?><!--</td>-->
                                ...
                                <td><button <?php if ($disableButton) echo 'disabled'; ?> onclick="pdf('<?php echo $row['doner_name']?>','<?php echo $row['mobile']?>',
                                            '<?php echo $row['amount']?>','<?php echo $row['date']?>','<?php echo $row['pan']?>','<?php echo $row['address']?>',
                                            '<?php echo $row['mobile1']?>','<?php echo $row['pay_mode']?>','<?php echo $row['type']?>','<?php echo $row['transaction_id']?>','<?php echo $row['dob']?>','<?php echo $row['pay_id']?>')"class="btn btn-success" type="button" id="pdf">PDF</button></td>
                                ...
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    if ($prevPage > 0) {
                                        ...
                                        <li class="page-item page-indicator"><a class="page-link"
                                                                                href="?page_no=<?php echo 1 ?>&search=<?php echo $search ?>&branch_nameS=<?php echo $branch_nameS ?>&from_date=<?php echo $from_date ?>&to_date=<?php echo $to_date ?>"><i
                                    ...
                                    {
                                        ?>
                                        <li class="page-item page-indicator"><a class="page-link" href="?page_no=<?php echo $prevPage?>&search=<?php echo $search ?>&branch_nameS=<?php echo $branch_nameS ?>&from_date=<?php echo $from_date ?>&to_date=<?php echo $to_date ?>"><i class="la la-angle-left" style ="margin-top: 8px;"></i></a></li>
                                        <?php
                                    }
                                    ...
                                    if (mysqli_num_rows($result)) {
                                        ...
                                        for ($i = 1; $i <= $pageFooter; $i++) {
                                            ...
                                            if($i<=($pageSql+10) && $i>$pageSql || $pageFooter<=10) {
                                                ...
                                                <li class="page-item <?php echo $active ?>"><a class="page-link"
                                                                                               href="?page_no=<?php echo $i ?>&search=<?php echo $search ?>&branch_nameS=<?php echo $branch_nameS ?>&from_date=<?php echo $from_date ?>&to_date=<?php echo $to_date ?>"><?php echo $i ?></a>
                                                </li>
                                                <?php
                                            }
                                        }
                                        ...
                                        {
                                            ?>
                                            <li class="page-item page-indicator"><a class="page-link" href="?page_no=<?php echo $nextPage ?>&search=<?php echo $search ?>&branch_nameS=<?php echo $branch_nameS ?>&from_date=<?php echo $from_date ?>&to_date=<?php echo $to_date ?>"><i class="la la-angle-right" style ="margin-top: 8px;"></i></a></li>
                                            <?php
                                        }
                                        if($nextPage<$pageFooter)
                                        {
                                            ?>
                                            <li class="page-item page-indicator"><a class="page-link" href="?page_no=<?php echo $pageFooter ?>&search=<?php echo $search ?>&branch_nameS=<?php echo $branch_nameS ?>&from_date=<?php echo $from_date ?>&to_date=<?php echo $to_date ?>"><i class="la la-angle-double-right"></i></a></li>
                                            <?php
                                        }
                                    }
                                    ?>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select  class="form-control" id="pay_mode" name="pay_mode" style="border-color: #181f5a;color: black">
                                            <option value='online'>UPI/NEFT/IMPS</option>
                                            <option value='offline'>FIELD/CASH</option>
                                        </select>
                                    </div>
                                    <!--                                    <div class="form-group col-md-12" >-->
...
<script>
    ...
    function pdf(name,mobile,amount,date,pan,address,mobile1,pay_mode,type,transaction_id,dob,pay_id) {
        ...
        window.location.href= 'https://atct.in/portal/receipt/pdf.php?name='+name+'&mobile='+mobile+'&amount='+amount+'&date='+date+'&pan='+pan+'&mobile1='+mobile1+'&address='+address+'&pay_mode='+pay_mode+'&type='+type+'&transaction_id='+transaction_id+'&dob='+dob+'&pay_id='+pay_id;
