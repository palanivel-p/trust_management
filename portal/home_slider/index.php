...
<!--                                <label>Slider</label>-->
                                <input type="text" class="form-control" placeholder="Search By Slider Name" name="search" id="search" style="border-radius:20px;color:black;" >
                            </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            <?php
                            if($search == "") {
                                $sql = "SELECT * FROM slider ORDER BY id  LIMIT $start,10";
                            }
                            else {
//                                $sql = "SELECT * FROM slider WHERE slider_name = '$search' ORDER BY id  LIMIT $start,10";
                                $sql = "SELECT * FROM slider WHERE slider_name LIKE '%$search%' ORDER BY id LIMIT $start, 10";
                            }
                            ...
                            <tr>
                                ...
                                <td style="cursor: pointer">   <span class="badge badge-pill <?php echo $img_upload?> ml-2" data-toggle="modal" data-target="<?php echo $img_modal?>" onclick="imgModal('<?php echo $row['slider_id']; ?>')">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" data-toggle="modal" data-target="#career_list" style="cursor: pointer" onclick="editTitle('<?php echo $row['slider_id'];?>')">Edit</a>
                                            <a class="dropdown-item" style="cursor: pointer" onclick="delete_model('<?php echo $row['slider_id'];?>')">Delete</a>
                        ...
                        <div class="col-12 pl-3" style="display: flex;justify-content: center;">
                            <nav>
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    $sql = "SELECT COUNT(id) as count FROM slider";

//                                    if($search == "all") {
//                                        $sql = "SELECT COUNT(id) as count FROM slider";
//                                    }
//                                    else {
//                                        $sql = "SELECT COUNT(id) as count FROM slider WHERE slider_name = '$search'";
//                                    }
                                    $result = mysqli_query($conn, $sql);
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="title">Slider</h5>
                            ...
                            <form id="career_form" autocomplete="off">
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="slider_name" id="slider_name" name="slider_name" style="border-color: #181f5a;color: black">
...
<script>
    function imgModal(src) {
        document.getElementById('modal_images').setAttribute("src",'slider_img/'+src+'.jpg');
    }
</script>
        ...
        $.ajax({
            ...
            success: function(res){
                if(res.status=='success')
                {
                    ...
                    $("#slider_name").val(res.slider_name);
                    ...
                    var edit_model_title = "Edit Slider - "+data;
    ...
    $("#career_form").validate(
        {
            ...
            messages: {
                slider_name: "*This field is required",
