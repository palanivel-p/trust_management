                                ...
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    if ($prevPage > 0) {
                                        ...
                                        <li class="page-item page-indicator"><a class="page-link"
                                                                                href="?page_no=<?php echo 1 ?>&branch_nameS=<?php echo $branch_nameS ?>&from_date=<?php echo $from_date ?>&to_date=<?php echo $to_date ?>"><i
                                    ...
                                    {
                                        ?>
                                        <li class="page-item page-indicator"><a class="page-link" href="?page_no=<?php echo $prevPage?>&branch_nameS=<?php echo $branch_nameS?>&from_date=<?php echo $from_date ?>&to_date=<?php echo $to_date ?>"><i class="la la-angle-left" style ="margin-top: 8px;"></i></a></li>
                                        <?php
                                    }
                                    ...
                                    if ($branch_nameS == 'all') {
                                        ...
                                        $sql = "SELECT COUNT(id) as count FROM transaction WHERE verify = 1 AND branch_name ='$branch_nameS' AND date  BETWEEN '$from_date' AND '$to_date' $addedBranchSerach";
                                    }
                                    ...
                                    if (mysqli_num_rows($result)) {
                                        ...
                                        for ($i = 1; $i <= $pageFooter; $i++) {
                                            ...
                                            if($i<=($pageSql+10) && $i>$pageSql || $pageFooter<=10) {
                                                ...
                                                <li class="page-item <?php echo $active ?>"><a class="page-link"
                                                                                               href="?page_no=<?php echo $i ?>&branch_nameS=<?php echo $branch_nameS?>&from_date=<?php echo $from_date ?>&to_date=<?php echo $to_date ?>"><?php echo $i ?></a>
                                                </li>
                                                <?php
                                            }
                                        }
                                        ...
                                        {
                                            ?>
                                            <li class="page-item page-indicator"><a class="page-link" href="?page_no=<?php echo $nextPage ?>&branch_nameS=<?php echo $branch_nameS?>&from_date=<?php echo $from_date ?>&to_date=<?php echo $to_date ?>"><i class="la la-angle-right" style ="margin-top: 8px;"></i></a></li>
                                            <?php
                                        }
                                        if($nextPage<$pageFooter)
                                        {
                                            ?>
                                            <li class="page-item page-indicator"><a class="page-link" href="?page_no=<?php echo $pageFooter ?>&branch_nameS=<?php echo $branch_nameS ?>&from_date=<?php echo $from_date ?>&to_date=<?php echo $to_date ?>"><i class="la la-angle-double-right"></i></a></li>
                                            <?php
                                        }
                                    }
                                    ?>
...
<script>
    ...
    $(document).on("click", ".excel_download", function () {
        window.location.href = "excel_download.php?search=<?php echo $search?>&branch_nameS=<?php echo $branch_nameS?>&f_date=<?php echo $f_date?>&t_date=<?php echo $t_date?>";
    });
