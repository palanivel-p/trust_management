                    ...
                    <div style="display: flex;justify-content: flex-end;">
                        <form class="form-inline">
                            ...
                            <div class="form-group mx-sm-3 mb-2">
                                ...
                                <input type="text" class="form-control" placeholder="Search By Event  Name" name="search" id="search" style="border-radius:20px;color:black;" >
                            </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            <?php
                            if($search == "") {
                                $sql = "SELECT * FROM event ORDER BY id  LIMIT $start,10";
                            }
                            else {
                                $sql = "SELECT * FROM event WHERE event_name = '$search' ORDER BY id  LIMIT $start,10";
                            }
                            ...
                            <tr>
                                ...
                                <td style="cursor: pointer">   <span class="badge badge-pill <?php echo $img_upload?> ml-2" data-toggle="modal" data-target="<?php echo $img_modal?>" onclick="imgModal('<?php echo $row['event_id']; ?>')">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" data-toggle="modal" data-target="#career_list" style="cursor: pointer" onclick="editTitle('<?php echo $row['event_id'];?>')">Edit</a>
                                            <a class="dropdown-item" style="cursor: pointer" onclick="delete_model('<?php echo $row['event_id'];?>')">Delete</a>
                        ...
                        <div class="col-12 pl-3" style="display: flex;justify-content: center;">
                            <nav>
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    $sql = 'SELECT COUNT(id) as count FROM event;';
                                    $result = mysqli_query($conn, $sql);
                            ...
                            <form id="career_form" autocomplete="off">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="Event_name" id="event_name" name="event_name" style="border-color: #181f5a;color: black">
                                        <input type="hidden" class="form-control"  id="api" name="api">
                                        <input type="hidden" class="form-control"  id="event_id" name="event_id">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label>Place*</label>
                                        <input type="text" class="form-control" placeholder="Place" id="place" name="place" style="border-color: #181f5a;color: black">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label>Date*</label>
                                    ...
                                    <div class="form-group col-md-12">
                                        <label>Time*</label>
                                        <input type="text" class="form-control" placeholder="eg. 8:00 am to 12:30 pm" id="time" name="time" style="border-color: #181f5a;color: black">
                                    </div>
                                    <div class="form-group col-md-12">
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="upload_image">Image (1 MB) * width 800px & 800px height</label>
        ...
        $.ajax({
            ...
            success: function(res){
                if(res.status=='success')
                {
                    ...
                    var edit_model_title = "Edit Event - "+data;
