...
if(isset($_POST['doner_name']) && isset($_POST['mobile']) &&isset($_POST['amount'])) {
    ...
    if (mysqli_num_rows($resValidateCookie) > 0) {
        ...
        $sqlInsert = "INSERT INTO `transaction`(`pay_id`,`doner_name`,`dob`,`address`,`mobile`,`pan`,`amount`,`pay_mode`,`added_by`,`branch_name`,`date`,`doner_id`,`mobile1`,`remark`,`transaction_id`,`type`) 
                                            VALUES ('','$doner_name','$dob','$address','$mobile','$pan','$amount','$pay_mode','$added_by','$branch_name','$date','$doneriD','$mobile1','$remark','$transaction_id','$type')";
