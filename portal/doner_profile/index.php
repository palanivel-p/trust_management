                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table class="table table-responsive-md" style="text-align: center;">
                            ...
                            <?php
                            if($search == "") {
                                $sql = "SELECT * FROM doner_profile WHERE verfied = 1 $addedBranchSerach ORDER BY id  LIMIT $start,10";
                            }
                            else {
                                $sql = "SELECT * FROM doner_profile WHERE mobile = '$search' AND verfied = 1 $addedBranchSerach ORDER BY id  LIMIT $start,10";
                            }
                            ...
                            <tr>
                                ...
                                <td> <?php echo $lastTransAmount?> </td>
