...
//    $today_vist = $num_mobile + $num_desktop;
    ...
    while (strtotime($fromDate1) < strtotime($end_date1))
    {
        ...
        $sqldesk="SELECT SUM(desktop) AS desktop  FROM dashboard_data WHERE date BETWEEN '$fromDate1' AND '$toDate'";
        $resdesk=mysqli_query($conn,$sqldesk);
        $arraydesk=mysqli_fetch_array($resdesk);
        $desktopChart=$arraydesk['desktop'];
        ...
        $sqlmob="SELECT SUM(mobile) AS mobile  FROM dashboard_data WHERE date BETWEEN '$fromDate1' AND '$toDate'";
        $resmob=mysqli_query($conn,$sqlmob);
        $arraymob=mysqli_fetch_array($resmob);
        $mobileChart=$arraymob['mobile'];
        ...
        $monthly_mob_chart.=$mobileChart.',';
        $monthly_disk_chart.=$desktopChart.',';
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-xxl-12 col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="mobile_desktop" style="width: 100%; height: auto;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    $( document ).ready(function() {
        ...
        Highcharts.chart('mobile_desktop', {
            ...
            title: {
                ...
                text: '<?php echo date("Y"); ?> Monthly Viewers Chart'
            ...
            series: [{
                ...
                data: <?php echo $monthly_mob_chart; ?>,
                ...
                data: <?php echo $monthly_disk_chart ?>,
